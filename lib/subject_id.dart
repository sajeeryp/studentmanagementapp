...
import 'model/subjectid_model.dart';
...
class _HomePageState extends State<Subjectid> {
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        child:  Padding(
                                          padding: EdgeInsets.all(10),
                                          child: Align(alignment: Alignment.topLeft,
                                            child: Text("Teacher : "+ user.teacher,
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  children:  [
                                                    ...
                                                    Text("Credits : "+user.credits.toString(),
                                                      style: TextStyle(
                                                        color: Colors.black,
                                                        fontSize: 15,
                                                      ),
